...
const Nav = () => {
  ...
  return (
    ...
    >
      ...
      xl:justify-center gap-y-10 px-4 md:px-40 xl:px-0 h-[80px] xl:h-max py-8 bg-white/10 backdrop-blur-sm text-3xl 
          ...
          return (
            ...
            >
              ...
              <div className="absolute pr-14 right-0 hidden xl:group-hover:flex">
                <div className=" bg-white relative flex text-primary items-center p-[6px] rounded-[12px] backdrop-blur-sm font-bold ">
                  <div className="text-[15px] capitalize">{item.name}</div>
                  {/* navigation trigle shape */}
